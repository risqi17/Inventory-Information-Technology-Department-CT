		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" action="{{ route('master.product.store') }}" method="POST">
						@csrf
						<div class="card-body">
							<div class="row">
								<div class="col-sm-5">
									<div class="mb-3">
										...
										<input class="form-control" id="exampleFormControlInput1" type="text" name="name" placeholder="Nama produk" required/>
									</div>
								</div>
							</div>
                            <div class="row">
