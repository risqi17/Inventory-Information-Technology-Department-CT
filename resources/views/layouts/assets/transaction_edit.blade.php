		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" action="{{ route('assets.main.transaction.update') }}" method="POST">
						@csrf
						<div class="card-body">
							<div class="row">
								<div class="col-sm-9">
									<div class="mb-3">
                                        ...
                                        <input class="form-control" id="exampleFormControlInput1" type="hidden" name="asset_id" value="{{ $asset->asset_id }}" required/>
									</div>
								</div>
							</div>
                            ...
                            <div class="row">
								<div class="col-sm-5">
									<div class="mb-3">
										...
										<select name="department" id="" class="js-example-basic-single">
											@foreach ($department as $item)
												<option value="{{ $item->id }}" @if ($item->id == $asset->department_id) selected @endif>{{ $item->name }}</option>
											@endforeach
										</select>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-sm-9">
									<div class="mb-3">
                                        ...
                                        <input class="form-control" id="exampleFormControlInput1" type="text" name="user" value="{{ $asset->user }}" autofocus required/>
                                    </div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-9">
									<div class="mb-3">
                                        ...
                                        <input class="form-control" id="exampleFormControlInput1" type="email" value="{{ $asset->email }}" name="email"/>
                                    </div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-9">
									<div class="mb-3">
                                        ...
                                        <input class="form-control" id="exampleFormControlInput1" type="text" value="{{ $asset->phone }}" name="phone"/>
                                    </div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-9">
									<div class="mb-3">
                                        ...
                                        <input class="form-control" id="exampleFormControlInput1" placeholder="ex. Dinas ke site" type="text" value="{{ $asset->needed }}" name="needed"/>
                                    </div>
								</div>
							</div>
                            <div class="row">
								<div class="col-sm-6">
									<div class="mb-3">
										...
										<input class="datepicker-here form-control digits" type="text" name="checkout_date" data-language="en" value="{{ $asset->transaction_date }}" required/>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="mb-3">
										...
										<input class="datepicker-here form-control digits" type="text" name="end_date" value="{{ $asset->end_date }}" data-language="en" />
									</div>
								</div>
							</div>
						</div>
