...
class AssetManagement extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['asset_number','service_tag','product_name','specification','warranty','category_id','purchase_date','uuid','quantity','status_checkin','status','image','conditions','updated_by', 'created_by','created_at','updated_at'];
